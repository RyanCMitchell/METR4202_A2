...
import itertools
import sys
from MatchingFunctions import findKeyPoints, drawKeyPoints, match, findKeyPointsDist, drawImageMappedPoints, saveImageMappedPoints
...
def MatchAll(ImageNo, maxdist=200):
    ...
    saveImageMappedPoints(img, KeyPointsTotalList, ImageNo)

if __name__== '__main__':
    for i in xrange(len(testimages)-1):
        MatchAll(i,20)
