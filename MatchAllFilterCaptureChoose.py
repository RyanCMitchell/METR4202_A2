...
def MatchAllCluster(save, maxdist=200, groups=3, filtparam=2.0):
    ...
    print distFromCenterAve1
    print distFromCenterAve2
    print distFromCenterAve3
    print distFromCenterAve4
    print distFromCenterAve5
    print sum(distFromCenterAve1)/len(distFromCenterAve1)
    print sum(distFromCenterAve2)/len(distFromCenterAve2)
    print sum(distFromCenterAve3)/len(distFromCenterAve3)
    print sum(distFromCenterAve4)/len(distFromCenterAve4)
    print sum(distFromCenterAve5)/len(distFromCenterAve5)
